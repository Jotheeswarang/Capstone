...
public class UserRegistrationSteps {
    ...
    public void user_logs_in_with_mobile_number_and_password(String number, String password) throws InterruptedException {
        userRegistration.clickLogin();
        userRegistration.login(number, password);
        Thread.sleep(5000);
    }

    @When("User changes the password to {string}")
    public void user_changes_the_password_to(String newPassword) throws InterruptedException {
        userRegistration.changePassword("Jone@2002", newPassword);
    }
